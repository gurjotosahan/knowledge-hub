...
export const RESEARCH_SECTIONS: ResearchSectionDef[] = [
  {
    ...
    searchQueryTemplate: "{{client}} company overview revenue employees headquarters leadership CEO CIO 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} business model revenue streams products services pricing customer segments 2024",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} strategic priorities digital transformation annual report CEO priorities initiatives 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} technology stack cloud AWS Azure GCP Salesforce SAP ERP CRM infrastructure 2024",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} challenges problems operational issues regulatory legacy technology debt 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} CIO CTO CDO technology leadership executives digital officer 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} hiring AI cloud digital transformation job postings technology investment 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} technology investment gaps modernization opportunities cloud AI digital 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} IT procurement decision making digital initiative stakeholder 2024 2025",
  ...
  },
  {
    ...
    searchQueryTemplate: "{{client}} IT outsourcing digital services vendor evaluation 2024 2025",
